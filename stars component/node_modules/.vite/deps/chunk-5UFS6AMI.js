...
function joinChildren(children, separator) {
  const childrenArray = React6.Children.toArray(children).filter(Boolean);
  return childrenArray.reduce((output, child, index) => {
    output.push(child);
    if (index < childrenArray.length - 1) {
      output.push(React6.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React6.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime4.jsx)(StackRoot, {
      as: component,
      ownerState,
      ref,
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5UFS6AMI.js.map
